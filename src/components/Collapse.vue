...
<template>
  <div class="container">
    <Collapse v-model="names" @on-change="show">
      <Panel name="1" hideArrow>
        史蒂夫·乔布斯
        <span
          slot="content"
        >史蒂夫·乔布斯（Steve Jobs），1955年2月24日生于美国加利福尼亚州旧金山，美国发明家、企业家、美国苹果公司联合创办人。</span>
      </Panel>
      <Panel name="2">
        斯蒂夫·盖瑞·沃兹尼亚克
        <p
        ...
        <div slot="content">
          ...
          <Collapse accordion v-model="value4">
            <Panel name="1-1">
              ...
              <p
                slot="content"
              >iPhone，是美国苹果公司研发的智能手机，它搭载iOS操作系统。第一代iPhone于2007年1月9日由苹果公司前首席执行官史蒂夫·乔布斯发布，并在2007年6月29日正式发售。</p>
            </Panel>
            <Panel name="1-2">
              iPad
              <p
